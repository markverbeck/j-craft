				...
				<div className="container">
					<div className="row">
						...
						<div className="col-md-7">
							<h2 id="bigText">That wood done slapped me up side the head..<span id ="bigLittleText">So I chainsawed it and turnt it inta a big ol' chair that I'm restin my butt on right now!</span></h2>
						</div>
					</div>
				</div>
